...
import LikedTour from "../Components/Tour/LikedTour";
...
const UserProfile = () => {
  ...
  const likedOnClick = () => setProfileActive("liked");
    ...
    <div className="grid grid-cols-[20%_80%] px-15 h-full">
      <div className="bg-[#38436C] py-5 text-white flex flex-col gap-5 justify-start items-center">
        ...
        <div className="menu mt-10 flex flex-col w-full pl-[20%]">
          ...
          {/* liked Tour Tab */}
          <div
            className={`w-full flex flex-row gap-5 px-2 py-3 text-blue-200 cursor-pointer ${profileActive === "liked" ? "text-white" : "text-blue-200"
              }`}
            onClick={likedOnClick}
          >
      ...
      {/* list of liked */}
      <LikedTour profileActive={profileActive} />
